...
#------------------------------------------------------------
imlist = []
for pp, prefix in enumerate(prefix_list):
	imlist += sorted(glob.glob(f"/large_data/processed/{prefix}/7DT??/*/calib*0.fits"))
	# imlist += sorted(glob.glob(f"/large_data/processed/{prefix}/7DT??/*/calib*com.fits"))
# ncore = 8
# ncore = 4
try:
