# In order to replace default.sex in config

simple_param = "/home/gp/gppy/config/simple.param"
simple_conv = "/home/gp/gppy/config/simple.conv"
simple_nnw = "/home/gp/gppy/config/simple.nnw"
...
PARAMETERS_NAME  {simple_param}   # name of the file containing catalog contents
...
FILTER_NAME      {simple_conv}    # name of the file containing the filter
...
PHOT_APERTURES   3,5,7          # MAG_APER aperture diameter(s) in pixels, 3", 5", 7"
...
STARNNW_NAME     {simple_nnw}     # Neural-Network_Weight table filename
