...
def phot_routine(inim):
	...
	presexcom = f"source-extractor -c {conf_simple} {inim} -FILTER_NAME {conv_simple} -STARNNW_NAME {nnw_simple} -PARAMETERS_NAME {param_simple} -CATALOG_NAME {precat} -GAIN {hdr['EXPTIME']} -GAIN_KEY FAKE"
	print(presexcom)
	os.system(presexcom)
