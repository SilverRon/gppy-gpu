...
try:
	...
	sbtbl = Skybot.cone_search(c_cent, fovval*u.deg, epoch, location=code)
	...
	print(f'No solar system object was found in the requested FOV ({fovval} deg)')
	pass
#------------------------------------------------------------
#	flag 1
#------------------------------------------------------------
...
print('-'*60)
bgstbl = hdtbl[hdtbl['flag']==True]
tctbl = hdtbl[hdtbl['flag']==False]
