...
path_gal = f'{path_base}/../processed_{n_binning}x{n_binning}_gain0'
...
path_mframe = f'{path_base}/master_frame_{n_binning}x{n_binning}_gain0'
...
rawlist = sorted(glob.glob(f'{path_raw}/2???-??-??_gain0'))
#------------------------------------------------------------
